...
static inline int pmi8952_dump_regs(void)
{
	return -ENXIO;
}
...
static inline int pmi8952_set_otg_pulse_skip(bool val)
{
	return -ENXIO;
}

static inline int pmi8952_get_otg_pulse_skip(void)
{
	return -ENXIO;
}

static inline int pmi8952_is_chg_safety_timer_timeout(int *result)
{
	return -ENXIO;
}

static inline int pmi8952_get_vbus(int *result)
{
	return -ENXIO;
}
