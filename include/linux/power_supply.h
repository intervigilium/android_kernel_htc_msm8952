...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_OVERLOAD, // CONFIG_HTC_BATT_8960
	...
	POWER_SUPPLY_PROP_HOT_TEMP, // CONFIG_HTC_BATT_8960
	POWER_SUPPLY_PROP_COLD_TEMP, // CONFIG_HTC_BATT_8960
	/*Place at the end: Properties below has no sysfs attribute*/
