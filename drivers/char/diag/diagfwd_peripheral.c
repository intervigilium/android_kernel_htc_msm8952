...
#include <linux/htc_flags.h>/*++ 2015/09/24, USB Team, PCN00086  ++*/

int diag_initialized;/*++ 2015/06/30, USB Team, PCN00052 ++*/
				   ...
				   unsigned char *buf, int len)
{
	...
	int ret = 0;/*++ 2015/06/30, USB Team, PCN00052 ++*/
