...
/*******************************************************************************
* Function:        fusb_PowerFusb302
* Input:           none
* Return:          true if Fusb302 is power on, false otherwise
********************************************************************************/
bool fusb_PowerFusb302(void);

/*******************************************************************************
* Function:        fusb_PowerVconn
* Input:           true: enable VCONN ; false: disable VCONN
* Return:          true if VCONN is power on, false otherwise
********************************************************************************/
bool fusb_PowerVconn(bool set);/*++ 2015/12/30, USB Team, PCN00006 ++*/
...
int fusb_ReStartIrq(int val);/*++ 2015/11/16, USB Team, PCN00001 ++*/
#else
