...
/*++ 2016/01/29, USB Team, PCN00016 ++*/
	if (blnEnable) {
		if (host_mode_status == 0) {
			...
			//printk("FUSB  [%s]: Already in Host mode, skip enable power\n", __func__);
		}
	} else {
		if (host_mode_status == 1) {
			...
			//printk("FUSB  [%s]: we are not in Host mode, skip disable power\n", __func__);
		}
	}
/*-- 2016/01/29, USB Team, PCN00016 --*/
                        ...
                        FSC_U8* Data)
{
    ...
    {
		writeI2C_failcount = 0;/*++ 2016/3/21, USB Team, PCN00023 ++*/
        ret = TRUE;
    }
    else  // I2C Write failure
    {
		writeI2C_failcount++;/*++ 2016/3/21, USB Team, PCN00023 ++*/
                       ...
                       FSC_U8* Data)
{
    ...
    else
    {
        for (i = 0; i < DataLength; i++)
        {
            ...
            {
				readI2C_failcount = 0;/*++ 2016/3/21, USB Team, PCN00023 ++*/
                Data[i] = temp;
                ret = TRUE;
            }
            else
            {
				readI2C_failcount++;/*++ 2016/3/21, USB Team, PCN00023 ++*/
